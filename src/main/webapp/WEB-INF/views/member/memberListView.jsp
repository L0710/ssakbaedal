...
<div class="wrapper">
        ...
        <section id="section">
            ...
            <div class="contents" align="center">
                ...
                <script>
	                $("th input[type=checkbox]").click(function() {	// 전체선택
	                ...
	                $('#acceptBtn').click(function() {
	    	            ...
	    	            $("td input[type=checkbox]:checked").each (function (index, item){
	    	                ...
	    	                mNo[index] = $(item).parent().parent().children().eq(1).text() ;
	    	            ...
	    	            if(mNo == "") {
	    	               ...
	    	               if (confirm("선택한 회원을 로그인 차단하시겠습니까?") == true) {
	    	            	   location.href='${contextPath}/memupdate.do?mNo='+mNo;
	    	               }
	    	            }
	                });
	             	...
	             	// 행 클릭 시 체크박스 클릭
                    $(function(){
                    	$('#memberList tr').click(function(event){
