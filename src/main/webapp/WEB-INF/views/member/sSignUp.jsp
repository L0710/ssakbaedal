...
제1조(목적) 이 약관은 ssakbaedal 회사(전자상거래 사업자)가 운영하는 ssakbaedal 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)

  ① “몰”이란 ssakbaedal 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제3조 (약관 등의 명시와 설명 및 개정) 
  ...
  ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 ssakbaedal 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <p id="textValue" disabled></p>
                    <form id="sign_up_form" enctype="multipart/form-data" style="display:none" >
                        <table id="sign_up_table">
                           ...
                           <button type="button" id="check_btn" >중복확인</button>
                            ...
                            <tr>
                                <td>전화번호</td>
                                <td >
                                <input type="text" id="phone1" maxlength="3" style="width:50px;height: 23px;">
                                -
                                <input type="text" id="phone2" maxlength="4" style="width:50px;height: 23px;">
                                -
                                <input type="text" id="phone3" maxlength="4" style="width:50px;height: 23px;">
                                </td>
                            </tr>
                        </table>
                        <br>
                        <table id="buisness_table">
                            ...
                            <tr>
                                <td>사업자등록번호</td>
                                <td>
                                <input type="text" id="sNumber1" maxlength="3" style="width:30px;height: 23px;">
                                -
                                <input type="text" id="sNumber2" maxlength="2" style="width:15px;height: 23px;">
                                -
                                <input type="text" id="sNumber3" maxlength="5" style="width:50px;height: 23px;">
                        ...
                        <table id="store_table" style="display:none" >
                            ...
                            <tr>
                                <td>매장 전화번호</td>
                                <td >
                                <input type="text" id="sTel1" name="phone1" maxlength="3" style="width:50px;height: 23px;">
                                -
                                <input type="text" id="sTel2" name="phone2" maxlength="4" style="width:50px;height: 23px;">
                                -
                                <input type="text" id="sTel3" name="phone3" maxlength="4" style="width:50px;height: 23px;">
                                </td>
                            </tr> 
                              <!--전화번호 유효성 두군데 수정  -->
                  <tr>
                  ...
                  <tr>
                     <td>배달가능 최소금액</td>
                     <td><p>
                           <input name="minPrice" type="number" placeholder="숫자만 입력해 주세요.">원
                        </p></td>
                  </tr>
                  <tr>
                     <td>가게 대표 이미지</td>
                  ...
                  <tr>
                        ...
                        <textarea id="openTime" name="openTime" style="display:none"></textarea>
                    </form>
                </div>
            </div>
        </section>
   ...
   $('input').on("keyup", function() {
      ...
      $('#buisness_table').on("mouseover focus", function() {
          ...
          if($.inArray(false, check2[0]) >= 0){
             checkAry[1] = false; 
             console.log("2번 테이블"+check2);
         }else{
             checkAry[1] = true; 
             console.log("2번 테이블"+check2);
             console.log("2번 테이블"+checkAry);
         }
       });
      ...
      var check4 = [];
       $('#menu_table').on("mouseover focus", function() {
          if($.inArray(false, check4) >= 0){
             checkAry[3] = false;
             console.log("4번 테이블"+check4);
         }else{
             checkAry[3] = true; 
             console.log("4번 테이블"+check4);
             console.log("4번 테이블"+checkAry);
         }
       });
