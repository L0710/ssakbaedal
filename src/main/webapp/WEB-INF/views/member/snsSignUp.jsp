  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<form id="sign_up_form"style="display:none" >
					<table id="sign_up_table">
						...
						<tr>
							<td>이메일</td>
							<td><input type="email" name="mEmail" value=${param.email}
	...
	<script>
		...
		var green = ({
			"border" : "2px solid rgb(130, 180, 127, 0.7)"
		});
				...
				.on(
						...
						function() {
							...
							for (var i = 0; i < 9; i++) {
								...
								switch (i) {
								case 0:
									check = (/^[a-zA-Z0-9]{6,10}$/).test(vput);
									break;
								case 1:
									check = (/^[a-zA-Z0-9]{8,12}$/).test(vput);
									break;
								case 2:
									check = (pwd == vput);
									break;
								case 3:
									check = (/^[가-힣]{2,}$/).test(vput);
									break;
								case 4:
									check = (/([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/)
											.test(vput);
									break;
								case 5:
									check = (/^[0-9]{3}$/).test(vput);
									break;
								case 6:
									check = (/^[0-9]{3,4}$/).test(vput);
									break;
								case 7:
