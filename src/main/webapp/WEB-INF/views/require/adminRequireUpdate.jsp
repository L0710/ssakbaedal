...
<body>
	<div class="wrapper">
		...
		<section id="section">
			...
			<div class="contents">
				<div id="asdf">
					<h1 style="font-size: 24px">문의사항 답변 수정</h1>
                </div>
				<form action="aReaAnswerUpdate.do" method="POST" enctype="multipart/form-data">
                    ...
                    <table align="center">
                        <tr>
                            <th>작성자</th>
                            <td>
                                <input type="text" name="rWriter" value="${ reply.rWriter }" size="80" readonly>
                            </td>
                        </tr>
                        <tr>
                            <th>답변내용</th>
                            <td>
                                <textarea cols="80" rows="7" name="rContent">${ reply.rContent }</textarea>
                            </td>
                        </tr>
                    </table>
