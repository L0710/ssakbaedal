	...
	<div class="wrapper">
		...
		<section id="section">
			...
			<div class="contents">
				...
				<form action="ureqUpdate.do" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="mNo" value="${ mNo }">
                    <input type="hidden" name="page" value="${ currentPage }">
                    <input type="hidden" name="reNo" value="${ require.reNo }">
                    <table id="inTabel" align="center">
                        <tr>
                            <th width="20%">제목</th>
                            <td>
                                <input type="text" name="reTitle" size="80" value="${ require.reTitle }">
                            </td>
                        </tr>
                        <tr>
                            <th>작성자</th>
                            <td>
                                <input type="text" name="reWriter" value="${ require.reWriter }" size="80" readonly>
                            </td>
                        </tr>
                        <tr>
                            <th>답변내용</th>
                            <td>
                                <textarea cols="80" rows="7" name="reContent">${ require.reContent }</textarea>
                            </td>
                        </tr>
                        <tr>
                        	<th>업로드한 파일</th>
