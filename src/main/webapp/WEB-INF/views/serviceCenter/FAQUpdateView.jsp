...
<div class="wrapper">
        ...
        <section>
            <div class="contents" align="center">
                ...
                <form action="upFAQ.do" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="page" value="${ currentPage }">
                    <input type="hidden" name="fNo" value="${ dFaq.fNo }">
                    <table id="inFAQ_table" align="center">
                        <tr>
                            <th width="20%">제목</th>
                            <td>
                                <input type="text" name="fTitle" size="80" value="${ dFaq.fTitle }">
                            </td>
                        </tr>
                        <tr>
                            <th>작성자</th>
                            <td>
                                <input type="text" name="fWriter" size="80" value="${ dFaq.fWriter }" readonly>
                            </td>
                        </tr>
                        <tr>
                            <th>내용</th>
                            <td>
                                <textarea cols="80" rows="7" name="fContent">${ dFaq.fContent }</textarea>
                            </td>
                        </tr>
                        <tr>
